...
def render_image_playground_tab(multimodal_model_pro: GenerativeModel):
    ...
    with recommendations:
        ...
        generate_image_description = st.button("Generate recommendation", type="primary", key="generate_image_description")
        with tab1:
    ...
    with screens:
        ...
        tab1, tab2 = st.tabs(["Response", "Prompt"])
        generate_instructions_description = st.button("Generate instructions", type="primary", key="generate_instructions_description")
        with tab1:
    ...
    with diagrams:
        ...
        tab1, tab2 = st.tabs(["Response", "Prompt"])
        er_diag_img_description = st.button("Generate documentation", type="primary",key="er_diag_img_description")
        with tab1:
    ...
    with equations:
        ...
        tab1, tab2 = st.tabs(["Response", "Prompt"])
        math_image_description = st.button("Generate answers", type="primary", key="math_image_description")
        with tab1:
