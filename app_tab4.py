...
def render_video_playground_tab(multimodal_model_pro: GenerativeModel):
    ...
    with video_desc:
        ...
        video_desc_description = st.button("Generate video description", type="primary", key="video_desc_description")
        with tab1:
    ...
    with video_tags:
        ...
        tab1, tab2 = st.tabs(["Response", "Prompt"])
        video_tags_desc = st.button("Generate video tags", type="primary",key="video_tags_desc")
        with tab1:
    ...
    with video_highlights:
        ...
        tab1, tab2 = st.tabs(["Response", "Prompt"])
        video_highlights_description = st.button("Generate video highlights", type="primary",key="video_highlights_description")
        with tab1:
    ...
    with video_geoloc:
        ...
        tab1, tab2 = st.tabs(["Response", "Prompt"])
        video_geolocation_description = st.button("Generate", type="primary",key="video_geolocation_description")
        with tab1:
